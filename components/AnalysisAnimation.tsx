...
const AnalysisAnimation: React.FC<AnalysisAnimationProps> = ({ onCapture, onComplete, lang }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-10 w-full max-w-4xl px-6 animate-slide-up">
      ...
      <div className="relative w-full aspect-video rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_80px_rgba(147,51,234,0.1)] bg-black">
        ...
        <div className="absolute inset-0 z-20 pointer-events-none">
          ...
          <div className="absolute top-10 left-10 w-12 h-12 border-t-2 border-l-2 border-purple-500"></div>
          <div className="absolute top-10 right-10 w-12 h-12 border-t-2 border-r-2 border-purple-500"></div>
          <div className="absolute bottom-10 left-10 w-12 h-12 border-b-2 border-l-2 border-purple-500"></div>
          <div className="absolute bottom-10 right-10 w-12 h-12 border-b-2 border-r-2 border-purple-500"></div>

          {/* Rotating Data Rings */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40%] aspect-square border-2 border-dashed border-purple-500/30 rounded-full animate-[spin_20s_linear_infinite]"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[45%] aspect-square border border-purple-500/20 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>
        </div>
      ...
      <div className="text-center space-y-6">
        <h2 className="text-white font-bebas text-5xl md:text-8xl tracking-widest drop-shadow-2xl h-24 flex items-center justify-center">
        ...
        <div className="flex flex-col items-center gap-3">
           ...
           <div className="flex gap-8 text-[9px] text-white/40 font-mono tracking-[0.2em] uppercase">
             <span>BIT-DEPTH: 24KB</span>
             <span>NEURAL SCAN: {Math.floor(progress)}%</span>
